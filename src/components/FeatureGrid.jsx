  ...
  const features = [
    {
      ...
      description: "Book appointments quickly and easily, often for the same or next day.",
      icon: (
    ...
    },
    {
      ...
      description: "We offer longer appointments so you can discuss all your health concerns without feeling rushed.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
    ...
    {
      title: "On-site labs",
      description: "Convenient on-site lab services save you an extra trip.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
    ...
    },
    {
        ...
        description: "Get care anytime, anywhere with our app, at no extra cost.",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
    ...
    <section className="bg-white py-20 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold tracking-tight text-[var(--gw-primary)] sm:text-4xl">
